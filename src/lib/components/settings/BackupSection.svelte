...
<style lang="postcss">
    ...
    section {
        ...
        #backup-buttons {
            @apply flex h-24 gap-2;

            button  {
                @apply flex w-full flex-col items-center justify-center gap-4 rounded-2xl border-1 border-zinc-300 dark:border-zinc-800 text-zinc-600;
            }
        }
    }
</style>